...
mod tests {
	...
	const ORACLE_FILES: [&[u8]; 31] = [
		...
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/adapters/bedrock-endpoints-regions.json"
		),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/adapters/direct-messages.encoder.json"
		),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/adapters/vertex-endpoints-errors.json"
		),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/adapters/vertex-raw-predict.encoder.json"
		),
		include_bytes!("../../../../fixtures/llm-oracle/anthropic/bedrock/eventstream-cases.json"),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/bedrock/eventstream.message-stop.bin"
		),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/bedrock/eventstream.service-unavailable.bin"
		),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/expected/server-tools-citations.outcome.json"
		),
		include_bytes!("../../../../fixtures/llm-oracle/anthropic/expected/terminal-errors.json"),
		include_bytes!("../../../../fixtures/llm-oracle/anthropic/expected/usage-matrix.json"),
		include_bytes!("../../../../fixtures/llm-oracle/anthropic/legacy/expect.fallback.json"),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/legacy/expect.server_tools_citations.json"
		),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/legacy/expect.thinking_tool_usage.json"
		),
		include_bytes!("../../../../fixtures/llm-oracle/anthropic/legacy/expect.truncated_tool.json"),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/legacy/request.media_projection.json"
		),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/legacy/request.native_controls.json"
		),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/legacy/request.tool_result_document.json"
		),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/legacy/request.tool_result_image.json"
		),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/legacy/request.tool_use_ordering.json"
		),
		include_bytes!("../../../../fixtures/llm-oracle/anthropic/legacy/response.error_429.json"),
		...
		include_bytes!("../../../../fixtures/llm-oracle/anthropic/legacy/stream.truncated_tool.sse"),
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/requests/conditional-controls.encoder.json"
		),
		include_bytes!(
		...
		include_bytes!(
			"../../../../fixtures/llm-oracle/anthropic/requests/thinking-modes.encoder.json"
		),
		include_bytes!("../../../../fixtures/llm-oracle/anthropic/shape-coverage.json"),
	];
	...
	#[test]
	fn every_json_oracle_is_well_formed_without_shape_traversal() {
		for (index, fixture) in ORACLE_FILES.iter().enumerate() {
			if matches!(index, 6 | 7 | 21 | 22 | 23 | 24) {
				continue;
			}
			serde_json::from_slice::<Box<RawValue>>(fixture).unwrap();
		}
	}
	...
	#[test]
	fn typed_request_shapes_cover_history_tools_results_media_and_controls() {
		for fixture in [
			include_bytes!(
				"../../../../fixtures/llm-oracle/anthropic/requests/conditional-controls.encoder.json"
			)
