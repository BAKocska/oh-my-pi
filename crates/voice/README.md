...
`omp-voice` owns OMP's platform audio boundary: low-latency mono `f32` microphone capture, gapless queued speaker playback, metering, gain, drain/abort behavior, and arbitration between speech-to-text, text-to-speech, and live voice.
