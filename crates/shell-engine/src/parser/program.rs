...
pub struct ParserOptions {
	...
	pub sh_mode: bool,
	/// Whether or not to perform tilde expansion for tildes at the start of
	/// words.
...
#[allow(dead_code, reason = "source metadata is retained for parser diagnostics")]
...
impl<R: io::BufRead> Parser<R> {
	...
	pub fn new(reader: R, options: &ParserOptions) -> Self {
		Self { reader, options: options.clone() }
	}
...
/// Parses a sequence of tokens into the abstract syntax tree (AST) of a shell
/// program.
///
/// # Arguments
///
