...
fn get_key_for_indexed_array(
	...
	#[expect(clippy::cast_possible_wrap, reason = "negative shell indices need signed arithmetic")]
	if index_value < 0 {
	...
	#[expect(clippy::cast_sign_loss, reason = "validated non-negative indices become u64")]
