...
command!(handoff, 121, "handoff", [], "Summarize this conversation into a new session", [Session, Execution], false, optional("[instructions]") => |host, instructions| host.handoff(instructions));
