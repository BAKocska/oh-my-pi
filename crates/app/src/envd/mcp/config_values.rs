...
use omp_llm_inference::auth::command::{CommandCredentialError, CommandCredentialResolver};
...
mod tests {
	...
	use omp_llm_inference::auth::command::{CommandCredentialExecutor, CommandExecutionFuture};
