...
pub(crate) struct GithubCredentialBridge {
	authority: OnceLock<Arc<dyn crate::auth_backend::CredentialAuthority>>,
}
...
impl GithubCredentialBridge {
	...
	pub(crate) fn bind(
		&self,
		authority: Arc<dyn crate::auth_backend::CredentialAuthority>,
	) -> Result<(), Arc<dyn crate::auth_backend::CredentialAuthority>> {
