...
In this file, the core-versus-device explanation and `shell_guard` dispatch example now use the `xd` shell builtin and its nested JSON argument mapping; the prior Revision 2.1 account remains unchanged.
